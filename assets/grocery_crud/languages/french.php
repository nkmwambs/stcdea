...
/* Translated by Tony LAURENT */
	...
	$lang['form_insert_loading'] 	= 'En attente, enregistrement des données...';

	$lang['form_upload_a_file'] 	= 'Envoyer un fichier';
	$lang['form_upload_delete'] 	= 'supprimer';
	$lang['form_button_clear'] 		= 'Réinitialiser';
	...
	$lang['error_on_uploading'] 	= "Une erreur est survenue lors de l'envoi.";
	$lang['message_prompt_delete_file'] 	= "Êtes-vous sûr de vouloir supprimer ce fichier ?";

	$lang['error_max_number_of_files'] 	= "Vous ne pouvez envoyer qu'un seul fichier à la fois.";
	$lang['error_accept_file_types'] 	= "Vous n'êtes pas autorisé à envoyer ce type de fichier.";
	$lang['error_max_file_size'] 		= "Le fichier dépasse la taille maximale autorisée de {max_file_size}.";
	$lang['error_min_file_size'] 		= "Vous ne pouvez pas envoyer un fichier vide.";
	...
	$lang['list_search_column'] = 'Chercher dans {column_name}';

	/* Added in version 1.5.8 */
	$lang['alert_delete_multiple'] = 'Êtes-vous sûr de vouloir supprimer ces {items_amount} éléments ?';
