		...
		<div class="col-sm-12">
			<div class="panel panel-primary " data-collapsed="0">
                    ...
                    <div class="panel-body">
						...
						<?php 
							echo form_open(base_url() . 'budget/insert_bva_update/', array('id'=>'frm_add_bva_update', 'class' => 'form-horizontal form-groups-bordered validate','enctype' => 'multipart/form-data'));
						...
						?>
							...
							<div class="form-group">
								<label class="control-label col-xs-4"><?=get_phrase('update_date');?></label>
								<div class="col-xs-8">
									<input type="text" class="form-control datepicker" data-format='yyyy-mm-dd' id="update_month" name="update_month" readonly="readonly" />
								</div>
							</div>
							
							<div class="form-group">
								<label class="control-label col-xs-4"><?=get_phrase('balance');?></label>
								<div class="col-xs-8">
...
<script>
	$("#frm_add_bva_update").submit(function(ev){
