		...
		<div class="col-sm-12">
			<div class="panel panel-primary " data-collapsed="0">
                    ...
                    <div class="panel-body">
						...
						<?php 
							echo form_open(base_url() . 'budget/insert_commitment_update/', array('id'=>'frm_add_commitment_update', 'class' => 'form-horizontal form-groups-bordered validate','enctype' => 'multipart/form-data'));
