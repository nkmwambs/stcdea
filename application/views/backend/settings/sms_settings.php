		...
		<div class="tabs-vertical-env">
			...
			<div class="tab-content">
				...
				<div class="tab-pane active" id="b-profile">
					...
					<?php echo form_open(base_url() . 'settings/sms_settings/active_service' , 
				...
				<div class="tab-pane" id="v-home">
					<?php echo form_open(base_url() . 'settings/sms_settings/clickatell' , 
						array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
						<div class="form-group">
				...
				<div class="tab-pane" id="v-profile">
					<?php echo form_open(base_url() . 'settings/sms_settings/twilio' , 
						array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
						<div class="form-group">
