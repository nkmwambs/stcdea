		...
		<div class="tab-content">
			...
			<div class="tab-pane active" id="edit" style="padding: 5px">
                <div class="">
						...
						echo form_open(base_url() . 'settings/manage_language/update_phrase/'.$current_editing_language  , array('id' => 'phrase_form'));
						$count = 1;
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered">
                    ...
                    <tbody>
                    	...
                    	<tr>
                        	...
                        	<td>
                            	<a href="<?php echo base_url();?>settings/manage_language/edit_phrase/<?php echo $field;?>"
                                	 class="btn btn-info">
                                		<?php echo get_phrase('edit_phrase');?>
                                </a>
                            	<a href="<?php echo base_url();?>settings/manage_language/delete_language/<?php echo $field;?>"
                                	rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('delete_language');?>" class="btn btn-warning" onclick="return confirm('Delete Language ?');">
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open(base_url() . 'settings/manage_language/add_phrase/' , array('class' => 'form-horizontal form-groups-bordered validate'));?>
                        <div class="padded">
			...
			<div class="tab-pane box" id="add_lang" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open(base_url() . 'settings/manage_language/add_language/' , array('class' => 'form-horizontal form-groups-bordered validate'));?>
                        <div class="padded">
                            <div class="form-group">
